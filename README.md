...
## 7. Аналитическая модель для OLAP

В качестве дополнительного задания реляционная модель была преобразована в аналитическую модель типа **«снежинка»** (допускается также интерпретация как «звезда»).

### Основные элементы аналитической модели:
...
Данная структура ориентирована на выполнение аналитических запросов и построение отчётов в системах бизнес-аналитики.
